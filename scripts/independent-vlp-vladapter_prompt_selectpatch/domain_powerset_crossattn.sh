...
# bash scripts/independent-vlp-vladapter_prompt/domain_forgetting_crossattn.sh $gpu_id visda17_df $seed vit_b16_ep50 8 $vision_depth $text_depth $use_domain_cls_loss $use_nearest_neighbor_loss $is_divided $shots synthetic
# bash scripts/independent-vlp-vladapter_prompt/domain_forgetting_crossattn.sh $gpu_id visda17_df $seed vit_b16_ep50 8 $vision_depth $text_depth $use_domain_cls_loss $use_nearest_neighbor_loss $is_divided $shots real
