...
SHOTS=${11}
USE_CROSSATTENTION=${12}
DATASETSEED=${13}
FORGET_DOMAIN=${14}
DIR=${15}
# KLDIV=${17}
# KLDIV_ONLY_PRV=${18}
# SUBEXPNAME=DC-${USE_DOMAIN_CLS_LOSS}_NN-${USE_NEAREST_NEIGHBOR_LOSS}_DIV-${IS_DOMAIN_DIVIDED}_InstPG-${USE_CROSSATTENTION} # _Penalty-${KLDIV}_ONLYPrv-${KLDIV_ONLY_PRV}
