...
class PromptLearner(nn.Module):
    def __init__(self, cfg, classnames, clip_model):
        ...
        n_ctx = cfg.TRAINER.COOP_W_DH.N_CTX
        ctx_init = cfg.TRAINER.COOP_W_DH.CTX_INIT
        ...
        self.class_token_position = cfg.TRAINER.COOP_W_DH.CLASS_TOKEN_POSITION
...
class CustomCLIP(nn.Module):
    def __init__(self, cfg, classnames, clip_model, domain_num):
        super().__init__()
...
class CoOp_w_DH_Divided(TrainerDF_COPY):
    ...
    def check_cfg(self, cfg):
        assert cfg.TRAINER.COOP_W_DH.PREC in ["fp16", "fp32", "amp"]
    ...
    def build_model(self):
        ...
        if cfg.TRAINER.COOP_W_DH.PREC == "fp32" or cfg.TRAINER.COOP_W_DH.PREC == "amp":
        ...
        # load_pretrained_weights(self.model.domain_separate_module, "/nas/data/gotoyuta/Result_Domain_Forgetting/pacs_df/DomainClassify/FORGET_DOMAIN1/sketch/vit_b16_ep50/seed1/20241011_221920/domain_separate_module/model.pth.tar-50")
        ...
        self.scaler = GradScaler() if cfg.TRAINER.COOP_W_DH.PREC == "amp" else None
