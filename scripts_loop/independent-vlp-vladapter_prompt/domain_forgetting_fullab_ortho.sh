...
USE_TEXT_ADAPTER=${16}
USE_ORTHOGONAL_LOSS=${17}
SUBEXPNAME=DC-${USE_DOMAIN_CLS_LOSS}_NN-${USE_NEAREST_NEIGHBOR_LOSS}_DIV-${IS_DOMAIN_DIVIDED}_InstPG-${USE_CROSSATTENTION}_ORTHOGONAL-${USE_ORTHOGONAL_LOSS}
...
USE_ORTHOGONAL_LOSS_FLAG=Falses
...
if [ "$USE_ORTHOGONAL_LOSS" = "true" ];then
    USE_ORTHOGONAL_LOSS_FLAG="True"
fi
...
python train_loop.py \
    ...
    USE_ORTHOGONAL_LOSS ${USE_ORTHOGONAL_LOSS_FLAG}
