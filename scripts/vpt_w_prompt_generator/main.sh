...
DIR=/nas/data/gotoyuta/Result_Domain_Forgetting/${DATASET}/${TRAINER}/FORGET_DOMAIN${DOMAIN_COUNT}/${DOMAIN_SEC}/${CFG}/nctx-vision${NCTX}_prmpt-depth${DEPTH_VISION}-text${NCTX}_topk${TOPK}/seed${SEED}/${TODAY}
if [ -d "$DIR" ]; then
