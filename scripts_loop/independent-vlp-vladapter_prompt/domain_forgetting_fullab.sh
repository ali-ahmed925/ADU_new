...
# KLDIV=${17}
# KLDIV_ONLY_PRV=${18}
SUBEXPNAME=DC-${USE_DOMAIN_CLS_LOSS}_NN-${USE_NEAREST_NEIGHBOR_LOSS}_DIV-${IS_DOMAIN_DIVIDED}_InstPG-${USE_CROSSATTENTION} # _Penalty${KLDIV}-ONLYPrv${KLDIV_ONLY_PRV}
