...
# 実行コマンド
for DROP_RATE in 0.0 0.3 0.5 0.7 1.0 ; do
    for DROP_DOMAIN_IDX in 0 ; do
        
        DIR=/nas/data/kawamura/ADU/${EXPNAME}/${SUBEXPNAME}/${DATASET}/drop_rate${DROP_RATE}_drop_idx${DROP_DOMAIN_IDX}/

        echo "Run this job and save the output to ${DIR}"


        echo "Running with DROP_RATE=${DROP_RATE}, DROP_DOMAIN_IDX=${DROP_DOMAIN_IDX}"
