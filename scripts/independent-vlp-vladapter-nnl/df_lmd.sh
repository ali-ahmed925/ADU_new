...
DIR=/nas/data/gotoyuta/Result_Domain_Forgetting/${DATASET}/${TRAINER}/FORGET_DOMAIN${DOMAIN_COUNT}/${DOMAIN_SEC}/${CFG}/nctx${NCTX}_prmpt-depth${DEPTH_VISION}_prtmp-txt${DEPTH_TEXT}_lmd-domain${LMD_DOMAIN_LOSS}/seed${SEED}/${TODAY}
if [ -d "$DIR" ]; then
    ...
    --output-dir ${DIR} \
    --lmd_domain_loss ${LMD_DOMAIN_LOSS}\
