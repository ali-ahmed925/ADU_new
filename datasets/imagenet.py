...
class ImageNet(DatasetBase):
    def __init__(self, cfg):
        ...
        root = os.path.abspath(os.path.expanduser("/nas/data/gotoyuta/Dataset")) 
        self.dataset_dir = os.path.join(root, self.dataset_dir)
        self.image_dir = os.path.join(self.dataset_dir, "images")
        self.preprocessed = os.path.join(self.dataset_dir, "preprocessed_new.pkl")
        ...
        if num_shots >= 1:
            ...
            preprocessed = os.path.join(self.split_fewshot_dir, f"shot_{num_shots}-seed_{seed}_new.pkl")
            ...
            if os.path.exists(preprocessed):
                ...
                #with open(preprocessed, "wb") as file: ####ここのpermission error @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
