...
USE_TEXT_ADAPTER=${16}
# SUBEXPNAME=
SUBEXPNAME=NCTX-${NCTX}_VISIONDEPTH-${DEPTH_VISION}_TEXTDEPTH-${DEPTH_TEXT}_VAdapter-${USE_VISION_ADAPTER}_TAdapter-${USE_TEXT_ADAPTER}
...
DIR=/nas/data/gotoyuta/Result_Domain_Forgetting_Loop/${DATASET}/${TRAINER}/SHOTS${SHOTS}/${CFG}/DC-${USE_DOMAIN_CLS_LOSS}_NN-${USE_NEAREST_NEIGHBOR_LOSS}_DIV-${IS_DOMAIN_DIVIDED}_InstPG-${USE_CROSSATTENTION}
